...
#This is the dictionary to pass arguments to the parallelized workers
args = {}
...
# This block just allows me to modify settings for the code by passing to the batch script via bash
...
# Here I just set the random seed between experiments to sample a range of initial weights
...
# Generate a wet mask from all input channels (obviously atmosphere boundary conditions do not contribute)
...
args["step_weights"] = [[1],[.2,.8],[.2,.2,.6],[.1,.1,.2,.8],[.1,.1,.1,.2,.7],[.1,.1,.1,.1,.2,.7],
                        [.1,.1,.1,.1,.1,.2,.7],[.1,.1,.1,.1,.1,.1,.2,.7]

args["step_lrs"] = [1e-4,5e-5,1e-5,1e-5,5e-6,5e-6,5e-6,5e-6]
